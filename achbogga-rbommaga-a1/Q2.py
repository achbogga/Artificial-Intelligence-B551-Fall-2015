#!/usr/bin/python
#Code fragments (specified at the beginning and ending) sources acknowledgements:

#Internet acknowledgement 1
...
##Declaration of the weighted grid
